...
<div class="col-md-12">
	...
	<?php else: ?>
		<table class="table table-bordered table-condensed table-striped">
			<thead> <th>#</th> <th>item</th> <th>Price</th> <th>Quantity</th> <th>size/type</th> <th>Sub Total</th></thead>
			<tbody>
			<?php
		...
		<table class="table table-bordered table-condensed text-right">			
			...
			<thead class="totals-table-header"><th>Total items</th> <th>Sub_Total</th> <th>Tax</th> <th>Grand Total</th>
			</thead>
			<tbody>
				<tr>	
					<td><?=$item_count;?></td>
...
<script>
	...
	jQuery.ajax({
		url : '/Project_ecommerce/admin/parsers/check_address.php',
		type : 'POST',
		data : data,
		...
		error: function(){alert('somthing went horribly wrong ')}, 
	});
	}
